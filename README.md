...
| Skill Camps | Skills  |
|-----------|---------------------|
| [🧠 **Security Monitoring, Detection & Response**](detection-response/) | [Splunk](detection-response/Splunk/). · [ELK](ELK/) · Threat Detection · MITRE ATT&CK Mapping · Incident Handling |
